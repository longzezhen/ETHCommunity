//
//  ETHAnnouncementViewController.m
//  ETHCommunity
//
...
@interface ETHAnnouncementViewController ()<WKNavigationDelegate>
@property (nonatomic,strong) BaseWKWebView * webView;
@end

@implementation ETHAnnouncementViewController
...
-(void)initView
{
    ...
    NSString * urlStr = [NSString stringWithFormat:@"%@?&token=%@&language=%@",HTML_Announcement,TOKEN,langStr];
