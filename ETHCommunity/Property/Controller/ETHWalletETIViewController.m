...
#import "ETHWalletETIDetailViewController.h"
@interface ETHWalletETIViewController ()<WKNavigationDelegate>
@property (nonatomic,strong) BaseWKWebView * webView;
@end

@implementation ETHWalletETIViewController
...
-(void)initView
{
    ...
    NSString * urlStr = [NSString stringWithFormat:@"%@?&token=%@&language=%@",HTML_ETIWallet,TOKEN,langStr];
//    NSString * urlStr = [NSString stringWithFormat:@"%@?&token=%@",HTML_ETIWallet,TOKEN];
...
-(void)clickRightItem
{
    ETHWalletETIDetailViewController * vc = [[ETHWalletETIDetailViewController alloc] init];
