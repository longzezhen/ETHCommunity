//
//  ETHChangeTransactionViewController.m
//  ETHCommunity
//
...
@interface ETHChangeTransactionViewController ()<WKNavigationDelegate>
@property (nonatomic,strong) BaseWKWebView * webView;
@end

@implementation ETHChangeTransactionViewController
...
-(void)initView
{
    ...
    NSString * urlStr = [NSString stringWithFormat:@"%@?&token=%@&language=%@",HTML_TransactionPassword,TOKEN,langStr];
//    NSString * urlStr = [NSString stringWithFormat:@"%@?&token=%@",HTML_TransactionPassword,TOKEN];
