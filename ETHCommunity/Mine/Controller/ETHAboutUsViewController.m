...
@interface ETHAboutUsViewController ()<WKNavigationDelegate>
@property (nonatomic,strong) BaseWKWebView * webView;
@end

@implementation ETHAboutUsViewController
...
-(void)initView
{
    ...
    NSString * urlStr = [NSString stringWithFormat:@"%@?&token=%@&language=%@",HTML_AboutUs,TOKEN,langStr];
//    NSString * urlStr = [NSString stringWithFormat:@"%@?&token=%@",HTML_AboutUs,TOKEN];
