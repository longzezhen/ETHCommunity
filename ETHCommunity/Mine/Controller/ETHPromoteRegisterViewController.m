//
//  ETHPromoteRegisterViewController.m
//  ETHCommunity
//
...
@interface ETHPromoteRegisterViewController ()<WKNavigationDelegate>
@property (nonatomic,strong) BaseWKWebView * webView;
@end

@implementation ETHPromoteRegisterViewController
...
-(void)initView
{
    ...
    NSString * urlStr = [NSString stringWithFormat:@"%@?&token=%@&language=%@",HTML_PromoteRegister,TOKEN,langStr];
//    NSString * urlStr = [NSString stringWithFormat:@"%@?&token=%@",HTML_PromoteRegister,TOKEN];
