...
@interface ETHVIPPrepayViewController ()<WKNavigationDelegate>
@property (nonatomic,strong) BaseWKWebView * webView;
@end

@implementation ETHVIPPrepayViewController
...
-(void)initView
{
    ...
    NSString * urlStr = [NSString stringWithFormat:@"%@?&token=%@&language=%@",HTML_VIPPrepay,TOKEN,langStr];
//    NSString * urlStr = [NSString stringWithFormat:@"%@?&token=%@",HTML_VIPPrepay,TOKEN];
